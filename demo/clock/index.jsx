...
/* HELPERS */
const mapRange = (start, end, increment, callback) => {
    const results = [];
...
const ClockFace = ({ time }) => {
    const abstract = (rotate) => `rotate(${(rotate * 360).toFixed(1)})`;
    ...
    return (<svg viewBox="0 0 100 100">
      <g transform="translate(50, 50)">
        ...
        {mapRange(0, 60, 1, i => (<line class="minor" y1={44} y2={45} transform={`rotate(${(360 * i) / 60})`}/>))}
        {mapRange(0, 12, 1, i => (<line class="major" y1={40} y2={45} transform={`rotate(${(360 * i) / 12})`}/>))}
