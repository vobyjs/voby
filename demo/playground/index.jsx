...
const TestTemplateExternal = () => {
    const Templated = template(props => {
...
const TestTemplateSVG = () => {
    ...
    useInterval(update, TEST_INTERVAL / 2);
    const Templated = template(props => {
        return (<svg viewBox="0 0 50 50" width="50px" stroke={props.color} stroke-width="3" fill="white">
        <circle cx="25" cy="25" r="20"/>
      </svg>);
    });
    return (<>
