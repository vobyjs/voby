...
type HydrationData = { phase: 0 | 1, elementCounter: number, textCounter: number, map: Partial<Record<string, Node>> };
...
type RenderOptions = { hydration?: boolean };
