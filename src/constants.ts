...
export {CONTEXTS_DATA, DIRECTIVE_OUTSIDE_SUPER_ROOT, HMR, SYMBOL_OBSERVABLE, SYMBOL_OBSERVABLE_FROZEN, SYMBOL_RESOLVE_UNWRAPPED, SYMBOL_UNTRACKED, SYMBOL_SUSPENSE, SYMBOL_TEMPLATE_ACCESSOR, SYMBOLS_DIRECTIVES};
